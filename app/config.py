...
class DiscordSettings(BaseSettings):
    ...
    bot_token: str = Field(default="dummy", description="Discord bot token")
...
class BinanceSettings(BaseSettings):
    ...
    api_key: str = Field(default="dummy", description="Binance API key")
    api_secret: str = Field(default="dummy", description="Binance API secret")
...
class AlpacaSettings(BaseSettings):
    ...
    api_key: str = Field(default="dummy", description="Alpaca API key")
    api_secret: str = Field(default="dummy", description="Alpaca API secret")
...
class DatabaseSettings(BaseSettings):
    ...
    password: str = Field(default="dummy")
...
class AppSettings(BaseSettings):
    ...
    secret_key: str = Field(
        default="dummy", description="Random secret key for JWT / session signing"
    )
